	...
	<section class="main-content">
	    ...
	    <div class="row offer-codebox">
	        ...
	        <div class="col-3 center-align display-block vertical-align">
	            <div class="code-css font-12"><a class="display-block no-uline black code" id="link1" href="/" onclick="copyToClipboard('#texttocopy')" data-toggle="popover" target="_blank"> <label id="texttocopy">Copy Code: TRIP20</label></a></div>
