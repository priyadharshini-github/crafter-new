	...
	<section class="main-content">
	    ...
	    <div class="row offer-codebox">
	        ...
	        <div class="col-3 center-align display-block vertical-align">
	            <div class="code-css font-12 code"><a class="display-block no-uline black" id="link1" href="/" onclick="copyToClipboard('#texttocopy')" data-toggle="popover" target="_blank"> <label id="texttocopy">Copy Code: TRIP20</label></a></div>
	    ...
	    <div class="row offer-codebox">
	        ...
	        <div class="col-3 center-align display-block vertical-align">
	            <div class="code-css font-12 code"><a class="display-block no-uline black" id="link2" href="/" onclick="copyToClipboard('#texttocopy')" data-toggle="popover" target="_blank"><label id="texttocopy">Copy Code: TRIP20</label></a></div>
	    ...
	    <div class="row offer-codebox">
	        ...
	        <div class="col-3 center-align vertical-align">
	            <div class="code-css font-12 code"><a class="display-block no-uline black" id="link3" href="/" onclick="copyToClipboard('#texttocopy')" data-toggle="popover" target="_blank"><label id="texttocopy">Copy Code: TRIP20</label></a></div>
