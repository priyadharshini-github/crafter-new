	    ...
	    <#list cpOffers as co>
    	    <div class="row offer-codebox">
    	        ...
    	        <div class="col-3 center-align display-block vertical-align">
    	            <div class="code-css font-12 code" data-moffers=${merchantOffers}?eval><button type="button" class="copy-code-btn" onclick="clickToCopy('${co.couponCode}')"> Copy Code: <span id="texttocopy">${co.couponCode}</span></button></div>
