...
// get vendor rule
def uriVendorRule = new URI("http://vendor-api.eba-adup9t5c.us-east-2.elasticbeanstalk.com/api/vendor/rakuten/rule")
org.apache.http.client.methods.HttpGet getVendorRuleRequest= new org.apache.http.client.methods.HttpGet(uriVendorRule);
...
if (vendorResponseEntity != null) {
 vendorRule = org.apache.http.util.EntityUtils.toString(vendorResponseEntity);
}
