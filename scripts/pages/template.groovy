...
templateModel.merchantOffers = "[{
		...
		"couponOffers": [{
			...
			},
			{
				...
				"couponCode": "COUP02",
				"offerDescription": "offer desc 2"
			}
		],
		"cbOffer": {
			"mid": 78,
			"commissionTerms": "sale : 0 and above 3%",
			"offerId": "546633",
			"offerName": "Works Discount Offer"
		}
	},
	{
		"merchant": {
		...
		"couponOffers": [{
			...
			},
			{
				...
				"couponCode": "COUP04",
				"offerDescription": "offer desc 4"
			}
		],
		"cbOffer": {
			"mid": 85,
			"commissionTerms": "sale : 0 and above 5%",
			"offerId": "7933",
			"offerName": "Facto Cashback Offer"
		}
	}
]"
